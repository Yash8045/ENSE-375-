...
public class Flight  
{
	...
	*/
	public static int calculateFlightTime() throws MoreThanOneDayException,NegativeTimeException, InvalidTimeException
	{
	...
	*				Throws NegativeTimeException   if the calculated time in minutes is negative
	 * @throws InvalidTimeException
	*/
	public static int calculateLayoverTime(Flight firstFlight,Flight nextFlight) throws MoreThanOneDayException,NegativeTimeException, InvalidTimeException
	{
